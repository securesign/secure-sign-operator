...
const (
	...
	ClientServerImage = "quay.io/redhat-user-workloads/rhtas-tenant/access-1-0-gamma/client-server-1-0-gamma@sha256:5a74147cd6edd9ee6627a02653a101ac3e927148576ab35467bacb65fd35ce98"
)
