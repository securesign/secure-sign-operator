...
func (r *TufReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		...
		Watches(&rhtasv1alpha1.Rekor{}, handler.EnqueueRequestsFromMapFunc(func(ctx context.Context, a client.Object) []reconcile.Request {
		...
		Watches(&rhtasv1alpha1.Fulcio{}, handler.EnqueueRequestsFromMapFunc(func(ctx context.Context, a client.Object) []reconcile.Request {
			...
			if err := mgr.GetClient().List(ctx, fulcios, client.MatchingLabels(t.Labels), client.InNamespace(t.Namespace)); err != nil {
				return requests
			}
