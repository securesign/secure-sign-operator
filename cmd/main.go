...
func main() {
	...
	utils.StringFlagOrEnv(&constants.ClientServerImage, "client-server-cg-image", "CLIENT_SERVER_CG_IMAGE", constants.ClientServerImage, "The image used to serve cosign and gitsign.")
