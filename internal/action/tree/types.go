...
func Wrapper[T tlsAwareObject](getTree, getStatusTree func(T) *int64, setStatusTree func(T, *int64), getTrillianService func(T) *rhtasv1.TrillianService) func(T) *wrapper[T] {
...
type wrapper[T tlsAwareObject] struct {
	...
	callTrillianService func(T) *rhtasv1.TrillianService
}
...
func (c *wrapper[T]) GetTrillianService() *rhtasv1.TrillianService {
