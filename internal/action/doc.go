...
//     and no watch event will fire. Use [BaseAction.Requeue] if you need
//     re-reconciliation, or [BaseAction.Return] if you are done.
//
// Example:
//
...
//	return i.Return()
//
//	// GOOD: use the changed flag to decide flow control
//	changed, err := i.PersistStatus(ctx, instance)
//	if err != nil {
//	    return i.Error(ctx, err, instance)
//	}
//	if !changed {
//	    return i.Requeue()  // no watch event — requeue as safety net
//	}
//	return i.Return()  // watch event will trigger next reconciliation
//
