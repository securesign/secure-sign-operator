...
func NewCreateMonitorAction() action.Action[*rhtasv1.Console] {
...
func (i monitoringAction) CanHandle(_ context.Context, instance *rhtasv1.Console) bool {
...
func (i monitoringAction) Handle(ctx context.Context, instance *rhtasv1.Console) *action.Result {
	var (
		err error
	)
