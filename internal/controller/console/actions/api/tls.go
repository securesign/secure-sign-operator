...
func NewTlsAction() action.Action[*rhtasv1alpha1.Console] {
	return &tlsAction{}
}
...
func (i tlsAction) CanHandle(_ context.Context, instance *rhtasv1alpha1.Console) bool {
...
func (i tlsAction) Handle(ctx context.Context, instance *rhtasv1alpha1.Console) *action.Result {
	switch {
	...
	case kubernetes.IsOpenShift():
		setStatusTLS(instance, rhtasv1alpha1.TLS{
			CertRef: &rhtasv1alpha1.SecretKeySelector{
				LocalObjectReference: rhtasv1alpha1.LocalObjectReference{Name: fmt.Sprintf(actions.ApiTLSSecret, instance.Name)},
				Key:                  "tls.crt",
			},
