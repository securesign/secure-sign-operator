...
func (i initializeAction) CanHandle(_ context.Context, instance *rhtasv1.Console) bool {
	return !meta.IsStatusConditionTrue(instance.Status.Conditions, actions.ApiCondition)
}

func (i initializeAction) Handle(ctx context.Context, instance *rhtasv1.Console) *action.Result {
	l := labels.ForComponent(actions.ApiComponentName, instance.Name)
	ok, err := commonUtils.DeploymentIsRunning(ctx, i.Client, instance.Namespace, l)
	switch {
