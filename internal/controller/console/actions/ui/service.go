...
func (i createServiceAction) CanHandle(ctx context.Context, instance *rhtasv1.Console) bool {
...
func (i createServiceAction) Handle(ctx context.Context, instance *rhtasv1.Console) *action.Result {
	...
	// TLS annotations for OpenShift - UI uses auto-generated TLS
	tlsAnnotations := map[string]string{
		annotations.TLS: fmt.Sprintf(actions.UITLSSecret, instance.Name),
	}
