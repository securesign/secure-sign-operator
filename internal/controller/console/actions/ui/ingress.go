...
func NewIngressAction() action.Action[*rhtasv1alpha1.Console] {
...
func (i ingressAction) CanHandle(_ context.Context, instance *rhtasv1alpha1.Console) bool {
	return instance.Spec.UI.ExternalAccess.Enabled &&
		instance.Spec.Enabled && state.FromInstance(instance, constants.ReadyCondition) >= state.Creating
}

func (i ingressAction) Handle(ctx context.Context, instance *rhtasv1alpha1.Console) *action.Result {
	var (
	...
	if result, err = kubernetes.CreateOrUpdate(ctx, i.Client,
		...
		kubernetes.EnsureIngressSpec(ctx, i.Client, *svc, instance.Spec.UI.ExternalAccess, actions.UiServerPortName),
