...
func (i deployAction) CanHandle(ctx context.Context, instance *rhtasv1.Console) bool {
...
func (i deployAction) ensureDbDeployment(instance *rhtasv1.Console, sa string, labels map[string]string) func(deployment *v2.Deployment) error {
