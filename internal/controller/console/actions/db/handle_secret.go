...
func NewHandleSecretAction() action.Action[*rhtasv1.Console] {
...
func (i handleSecretAction) CanHandle(_ context.Context, instance *rhtasv1.Console) bool {
...
func (i handleSecretAction) Handle(ctx context.Context, instance *rhtasv1.Console) *action.Result {
	// external database
	if !enabled(instance) {
