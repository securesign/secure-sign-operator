...
func TestGenerateSigner_CanHandle(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			canHandle: true,
			signer: rhtasv1.RekorSigner{
				KeyRef: &common.SecretKeySelector{LocalObjectReference: common.LocalObjectReference{Name: "secret"}, Key: "private"},
			},
		},
		{
		...
		},
		{
			...
			canHandle: true,
			signer: rhtasv1.RekorSigner{
				KeyRef: &common.SecretKeySelector{LocalObjectReference: common.LocalObjectReference{Name: "new_secret"}, Key: "private"},
			},
			statusSigner: rhtasv1.RekorSigner{
				KeyRef: &common.SecretKeySelector{LocalObjectReference: common.LocalObjectReference{Name: "old_secret"}, Key: "private"},
			},
		},
		{
			name: "spec.signer.keyRef == status.signer.keyRef",
		...
		},
		{
			...
			signer: rhtasv1.RekorSigner{
				KeyRef:      &common.SecretKeySelector{LocalObjectReference: common.LocalObjectReference{Name: "secret"}, Key: "private"},
				PasswordRef: &common.SecretKeySelector{LocalObjectReference: common.LocalObjectReference{Name: "secret"}, Key: "password"},
			},
			statusSigner: rhtasv1.RekorSigner{
				KeyRef:      &common.SecretKeySelector{LocalObjectReference: common.LocalObjectReference{Name: "secret"}, Key: "private"},
				PasswordRef: &common.SecretKeySelector{LocalObjectReference: common.LocalObjectReference{Name: "secret"}, Key: "password"},
		...
		},
		{
			...
			canHandle: true, signer: rhtasv1.RekorSigner{
				KeyRef:      &common.SecretKeySelector{LocalObjectReference: common.LocalObjectReference{Name: "new_secret"}, Key: "private"},
				PasswordRef: &common.SecretKeySelector{LocalObjectReference: common.LocalObjectReference{Name: "new_secret"}, Key: "password"},
			},
			statusSigner: rhtasv1.RekorSigner{
				KeyRef:      &common.SecretKeySelector{LocalObjectReference: common.LocalObjectReference{Name: "old_secret"}, Key: "private"},
				PasswordRef: &common.SecretKeySelector{LocalObjectReference: common.LocalObjectReference{Name: "old_secret"}, Key: "password"},
			},
		},
		{
