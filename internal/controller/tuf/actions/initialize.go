...
func (i initializeAction) CanHandleError(_ context.Context, _ *rhtasv1alpha1.Tuf) bool {
	return false
}

func (i initializeAction) HandleError(_ context.Context, _ *rhtasv1alpha1.Tuf) *action.Result {
	return i.Continue()
}
