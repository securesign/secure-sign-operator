...
func (i monitoringAction) CanHandle(_ context.Context, instance *rhtasv1.Trillian) bool {
...
func (i monitoringAction) Handle(ctx context.Context, instance *rhtasv1.Trillian) *action.Result {
	var (
		err error
	)
