...
func NewInitializeAction() action.Action[*rhtasv1.TimestampAuthority] {
...
func (i initializeAction) CanHandle(_ context.Context, instance *rhtasv1.TimestampAuthority) bool {
	return state.FromInstance(instance, constants.ReadyCondition) == state.Initialize
}

func (i initializeAction) Handle(ctx context.Context, instance *rhtasv1.TimestampAuthority) *action.Result {
	var (
		ok  bool
		err error
	)
