...
func TestEnsurePKCS11Config_CanHandle(t *testing.T) {
	tests := []struct {
			...
			instance: &rhtasv1.Fulcio{
				Spec: rhtasv1.FulcioSpec{
					Signer: rhtasv1.FulcioSigner{
						Type: rhtasv1.FulcioSignerTypeFile,
					},
				},
		...
		{
			name: "pkcs11 mode, condition set - skip",
			instance: &rhtasv1.Fulcio{
				Spec: rhtasv1.FulcioSpec{
					Signer: rhtasv1.FulcioSigner{
						Type: rhtasv1.FulcioSignerTypePKCS11,
						PKCS11: &rhtasv1.FulcioPKCS11Config{
							ConfigRef: rhtasv1.SecretKeySelector{LocalObjectReference: rhtasv1.LocalObjectReference{Name: "conf"}, Key: "crypto11.conf"},
						},
					},
				},
				Status: rhtasv1.FulcioStatus{
			...
			instance: &rhtasv1.Fulcio{
				...
				Spec: rhtasv1.FulcioSpec{
					Signer: rhtasv1.FulcioSigner{
						Type: rhtasv1.FulcioSignerTypePKCS11,
						PKCS11: &rhtasv1.FulcioPKCS11Config{
							ConfigRef: rhtasv1.SecretKeySelector{LocalObjectReference: rhtasv1.LocalObjectReference{Name: "hsm-config"}, Key: "crypto11.conf"},
						},
					},
				},
				Status: rhtasv1.FulcioStatus{
