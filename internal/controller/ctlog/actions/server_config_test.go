					...
					&v1.Secret{
						ObjectMeta: metav1.ObjectMeta{
							...
							Annotations: map[string]string{
								trillianURLAnnotation:   "trillian-logserver.default.svc:80",
								treeIDAnnotation:        "123456",
								privateKeyRefAnnotation: "secret",
								certAnnotation:          "[{\"name\":\"secret\",\"key\":\"cert\"}]",
							},
						},
