...
func TestCtlogMonitoringConfig_IsEnabled(t *testing.T) {
	t.Parallel()
	g := NewWithT(t)
	cfg := ctlogMonitoringConfig{}
...
func TestCtlogMonitoringConfig_TLS(t *testing.T) {
	t.Parallel()
	g := NewWithT(t)
	tls := ctlogMonitoringConfig{}.TLS(&rhtasv1.CTlog{})
