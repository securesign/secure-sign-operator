...
func Test_ValidatePrivateKeyPEM(t *testing.T) {
	...
	tests := []testCase{
		...
		},
		{
			...
			fipsEnabled: true,
			build: func(t *testing.T) ([]byte, []byte) {
				return fipsTest.GenerateECPrivateKeyPEM(t, elliptic.P256()), nil
			},
			wantErr: nil,
		},
		{
			...
			fipsEnabled: true,
			build: func(t *testing.T) ([]byte, []byte) {
				return fipsTest.GenerateECPrivateKeyPEM(t, elliptic.P224()), nil
			},
			wantErr: ErrKeyTooSmall,
		},
		{
...
func Test_ValidatePublicKeyPEM(t *testing.T) {
	...
	tests := []testCase{
		...
		},
		{
			...
			fipsEnabled: true,
			build: func(t *testing.T) []byte {
				return fipsTest.GenerateECPublicKeyPEM(t, elliptic.P256())
			},
			wantErr: nil,
		},
		{
			...
			fipsEnabled: true,
			build: func(t *testing.T) []byte {
				return fipsTest.GenerateECPublicKeyPEM(t, elliptic.P224())
			},
			wantErr: ErrKeyTooSmall,
		},
		{
