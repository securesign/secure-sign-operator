...
func CreateIngress(ctx context.Context, cli client.Client, svc v12.Service, conf rhtasv1.ExternalAccess, port string, labels map[string]string) (*networkingv1.Ingress, error) {
...
func EnsureIngressSpec(ctx context.Context, cli client.Client, svc v12.Service, conf rhtasv1.ExternalAccess, port string) func(ingress *networkingv1.Ingress) error {
