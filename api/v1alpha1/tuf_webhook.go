...
//+kubebuilder:webhook:path=/mutate-rhtas-redhat-com-v1alpha1-tuf,mutating=true,failurePolicy=fail,sideEffects=None,groups=rhtas.redhat.com,resources=tufs,verbs=create;update,versions=v1alpha1,name=mtuf.kb.io,admissionReviewVersions=v1
