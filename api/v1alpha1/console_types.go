...
type ConsoleDB struct {
	...
	// Reference to the secret containing database connection details.
	// This field is managed by the operator and contains the name of the secret
	// created by the operator or referenced by the user via Auth.
	//+optional
