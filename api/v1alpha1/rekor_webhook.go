...
//+kubebuilder:webhook:path=/mutate-rhtas-redhat-com-v1alpha1-rekor,mutating=true,failurePolicy=fail,sideEffects=None,groups=rhtas.redhat.com,resources=rekors,verbs=create;update,versions=v1alpha1,name=mrekor.kb.io,admissionReviewVersions=v1
