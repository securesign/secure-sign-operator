...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CtlogCert) DeepCopyInto(out *CtlogCert) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CtlogCert.
func (in *CtlogCert) DeepCopy() *CtlogCert {
	if in == nil {
		return nil
	}
	out := new(CtlogCert)
